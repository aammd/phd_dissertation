...
\item
  ...
  with organism size, we would predict that habitat (species identity of containing bromeliad) would affect the
...
We distinguished among our three predictions (Figure \ref{fig:illustration}) with a
