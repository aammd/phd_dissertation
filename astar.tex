...
\textbf{Step 2:} Species abundances can create spurious patterns in size
...
\includegraphics{../figures/pairwise_astars.png} Figure 2: Pairwise
...
\includegraphics{../figures/overall_null.png} Figure 3: Mean pairwise
...
\includegraphics{../figures/ses_rank.png}\\
...
\includegraphics{../figures/astar.png} Figure 5: Differences in observed
...
\includegraphics{../figures/xbar.png} Figure 6: Differences in habitat
...
\includegraphics{../figures/poly_curve.png} Figure 7: Two closely
...
differ less in their size thresholds (linear contrast from ANOVA, mean ±
sd 0.017 ± 0.66). Comparing the actual with null model pattern, we can
...
simulations -0.0091 ± 0.35, mean ± sd; SES of observed slope, 0.593, p =
0.27, Figure 1.).
...
\includegraphics{../figures/anova_data.png}\\
Figure 9: Survival (larvae + emergences) of \emph{P. marcondesi} and
\emph{P. kaingang}.

\includegraphics{../figures/confints.png} Figure 8: confidence
intervals\\
