...
species pairs; black line shows a linear regression of \(D_{b_{ij}}\) as a function of taxonomic rank. However, these regressions are not significantly different from a null model.}
...
\emph{P. kaingang} across all biotic treatments. Predation had a large effect on both species, while competition had no effect.}
...
insignificant (p = 0.0681, Figure \ref{fig:astar_x_taxo}).
...
performance by 95\% in \emph{P. kaingang} (see Figure \ref{fig:contrasts} for
