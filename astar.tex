...
\caption[Differences in \(A^{*}\)) and (\(x\)) between pairs of species]{Differences in \(A^{*}\)) and (\(x\)) between pairs of species, as a function of
their taxonomic similarity, measured as the lowest taxonomic rank in
common between the two species. \(A^{*}\)) is the inflection point of the indicende function, while (\(x\)) is its slope. Black dots indicate observed
species pairs; black line shows a linear regression of \(D_{b_{ij}}\) as a function of taxonomic rank. We observed
no relationship between differences and taxonomic relatedness.}
...
differ less in their size thresholds (slope $\pm$
